      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-12 mb-16">
          ...
          <div className="col-span-12 md:col-span-9 mt-6 md:mt-0">
            <h2 className="text-2xl md:text-3xl font-normal tracking-tight text-black uppercase">About Us</h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 gap-4 md:gap-8">
          ...
          <div className="col-span-12 md:col-span-4 flex flex-col justify-between">
            <p className="text-gray-800 font-light leading-relaxed mb-12">
              At Bahía Connect, we are experts in the administration of condominiums and civil associations. We offer
              comprehensive solutions for the management of common areas and residential units.
            </p>
            <p className="text-gray-800 font-light leading-relaxed">
              Ensuring efficiency, safety, and well-being for all users. Backed by over 23 years of experience.
            </p>
            <div className="mt-12">
              <a
                href="/en/about"
