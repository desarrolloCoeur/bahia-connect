          ...
          <div className="col-span-12 md:col-span-8">
            ...
            <div className="relative">
              ...
              <p className="text-xl md:text-2xl lg:text-3xl font-light text-white leading-relaxed md:leading-relaxed lg:leading-relaxed max-w-3xl">
                Dear Bahía is our chapter or section of the organization where we like to give recognition with the goal of encouraging a greater number of actions from our clients and the projects we work with.
                <br />
