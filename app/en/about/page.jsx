          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 md:col-span-5">
              <p className="text-lg font-light leading-relaxed">
                We specialize in property management, condominium administration, and consulting services. With over 18 years of experience in property operations and maintenance in Punta Mita, and more than 15 years managing vacation rentals and residences comprehensively. Our approach focuses on providing reliable, personalized solutions with attention to detail, so you can simply enjoy your investment.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 gap-8 mb-20">
            ...
            <div className="col-span-12 md:col-span-9">
              ...
              <p className="text-gray-800 font-light leading-relaxed max-w-3xl">
                Our vision is to establish ourselves as leaders in high-end property management and vacation rentals, offering innovative and customized solutions that maximize each property's performance. Through our <span className="font-normal text-sky-600">highly skilled and committed team</span>, we aim to exceed quality standards, providing peace of mind and trust to our clients through transparent, efficient, and results-oriented service. With a focus on operational excellence and sustainability, we strive to create long-term value for owners, tenants, and communities.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 md:col-span-6">
              ...
              <p className="text-gray-800 font-light leading-relaxed">
                Our primary objective is to provide high-quality property management services that maximize our clients' investment value. We strive to maintain properties in optimal condition, ensure tenant and owner satisfaction, and optimize financial returns through efficient and transparent management.
              </p>
            </div>
          </div>
        </div>
