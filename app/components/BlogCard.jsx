    ...
    <Link href={`/blogs/${slug}`} className="group">
      <article className="h-full flex flex-col bg-white shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
        <div className="p-6 flex-1">          
          <span className="inline-block px-3 py-1 mb-3 bg-sky-700 text-white text-xs">
            {category}
          </span>
          <Image className="w-full h-[200px] object-cover my-2"
           src={img} alt={img} width={300} height={200} />
          <h3 className="text-xl text-gray-800 group-hover:text-sky-800 transition-colors">
            {title}
          </h3>
